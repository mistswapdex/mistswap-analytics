      ...
      <PageHeader>
        <Box display="flex" alignItems="center" className={classes.pageHeader}>
          ...
          <Box display="flex" alignItems="center" className={classes.links}>
            <Link
              href={`https://app.mistswap.fi/#/add/${pair.token0.id}/${pair.token1.id}`}
              target="_blank"
              variant="body1"
            ...
            <Link
              href={`https://app.mistswap.fi/#/swap?inputCurrency=${pair.token0.id}&outputCurrency=${pair.token1.id}`}
              target="_blank"
              variant="body1"
            >
              Trade
